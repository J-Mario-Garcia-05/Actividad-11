def ordenar_carnet(carnet):
    if len(carnet) <= 1:
        return carnet
    pivote = carnet[0]
    menores = [x for x in carnet if x < pivote]
    iguales = [x for x in carnet if x == pivote]
    mayores = [x for x in carnet if x > pivote]
    return ordenar_carnet(menores) + iguales + ordenar_carnet(mayores)
     ...
     match opcion:
         ...
         case "2":
             if estudiantes:
                 ...
                 ordenar_estudiantes = ordenar_carnet(list(estudiantes.keys()))
